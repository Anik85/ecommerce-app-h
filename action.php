...
if(isset($_POST["category"])){
	...
	echo "
		<div class='nav nav-pills nav-stacked'>
			<li class='active'><a href='#' style='background-color: #598e6e;'><h4>Product Categories</h4></a></li>
	";
	if(mysqli_num_rows($run_query) > 0){
		while($row = mysqli_fetch_array($run_query)){
			...
			echo "
					<li><a href='#' class='category' cid='$cid' style='color: #598e6e;'>$cat_name</a></li>
			";
		}
		echo "</div>";
	}
...
if(isset($_POST["brand"])){
	...
	echo "
		<div class='nav nav-pills nav-stacked'>
			<li class='active'><a href='#' style='background-color: #598e6e;'><h4>Brands</h4></a></li>
	";
	if(mysqli_num_rows($run_query) > 0){
		while($row = mysqli_fetch_array($run_query)){
			$bid = $row["brand_id"];
			...
			echo "
					<li><a href='#' class='selectBrand' bid='$bid' style='color: #598e6e;'>$brand_name</a></li>
			";
		}
		echo "</div>";
	}
			...
			echo "
				<div class='col-md-4'>
							<div class='panel panel-info'>
								<div class='panel-heading' style='background-color: #598e6e;'>$pro_title</div>
								<div class='panel-body'>
									<img src='product_images/$pro_image' style='width:220px; height:250px;'/>
								</div>
								<div class='panel-heading' style='background-color: #598e6e;'>".CURRENCY.". $pro_price.00/-
									<button pid='$pro_id' style='float:right;' id='product' class='btn btn-info btn-xs'>Add To Cart</button><br>
			...
			echo "
				<div class='col-md-4'>
							<div class='panel panel-info'>
								...
								<div class='panel-heading' style='background-color: #598e6e;'>Tk.$pro_price.00/-
									<button pid='$pro_id' style='float:right;' id='product' class='btn btn-info btn-xs'>Add To Cart</button><br>
									<span class='fa fa-star checked' style='color: orange;'></span>
								<span class='fa fa-star checked' style='color: orange;'></span>
								<span class='fa fa-star checked' style='color: orange;'></span>
						...
						<form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
							...
							echo   
								'<input type="hidden" name="return" value="http://localhost/project1/payment_success.php"/>
									...
									src="product_images/checkout.png" alt="PayPal Checkout"
